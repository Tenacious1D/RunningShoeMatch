...
import { CalendarClock, Database, ExternalLink, Footprints, Store, Tags } from "lucide-react";
...
export default async function AdminDashboardPage() {
  ...
  return (
    <main>
      ...
      <section aria-label="Database summary" className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
